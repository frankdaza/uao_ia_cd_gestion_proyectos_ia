# Roles Scrum ML del equipo

Asignación nominal para el laboratorio **Dry Bean** (UCI 602), según el plan de equipos (**P1**) y los integrantes autorizados en [`backlog/config.yml`](../../backlog/config.yml). **No se utilizan nombres fuera de esa lista.**
...
Durante este laboratorio los roles se mantienen **fijos** (sin rotación por sprint). Si el docente o el equipo acordara rotación, se registraría aquí la regla y las fechas de cambio.
